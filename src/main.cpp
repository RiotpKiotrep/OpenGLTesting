...
int main()
{
	...
	Shader shaderProgram(RESOURCES_PATH "vertex.vert", RESOURCES_PATH "fragment.frag");
	...
	*/
	...
	unsigned char* data = stbi_load(RESOURCES_PATH "fish.png", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		trans = glm::mat4(1.0f);
		//trans = glm::translate(trans, glm::vec3(0.5f, 0.5f, 0.0f));
		trans = glm::rotate(trans, (float)glfwGetTime()*-1.0f, glm::vec3(0.0, 0.0, 1.0));
		glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans));
		*/
		glBindVertexArray(VAO);
		/*
